...
public:
    ...
    virtual DataSourcePtr hasSource(const cxxopts::ParseResult& vm)
    {
    ...
    DataSourcePtr default_hasSource(const cxxopts::ParseResult& vm)
    ...
    virtual DataSinkPtr hasSink(DataSource& src, const cxxopts::ParseResult& vm)
    {
...
//       .def("nextHeader", &IEEE802_1Q::nextHeader, return_value_policy<copy_non_const_reference>())
    ...
    class_<cxxopts::ParseResult, boost::noncopyable>("variables_map")
        .def("__getitem__", &cxxopts::ParseResult::operator[], return_value_policy<reference_existing_object>())
        .def("__setitem__", &cxxopts::ParseResult::operator[], return_value_policy<reference_existing_object>())
        .def("clear", &cxxopts::ParseResult::clear)
        .def("notify", &cxxopts::ParseResult::notify)
        .def("count", &cxxopts::ParseResult::count)
    ;
