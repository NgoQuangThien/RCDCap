...
public:
     ...
     */
    virtual RCDCap::DataSinkPtr hasSink(RCDCap::DataSource& src, const cxxopts::ParseResult& vm) final;
};
...
RCDCap::DataSinkPtr StatisticsPlugin::hasSink(RCDCap::DataSource& src, const cxxopts::ParseResult& vm)
{
