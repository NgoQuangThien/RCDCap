...
class DLL_EXPORT MACHeader802_1Q
{
//  uint8   m_Preamble;
    mac_t                                       m_DstMAC;       //!< The destination physical address.
    mac_t                                       m_SrcMAC;       //!< The source physical address.
...
public:
    ...
    static constexpr uint32 getVLANTagSize() { return 4; }
...
class DLL_EXPORT RouterAdvertisementHeader: public ICMPv6Header
{
    enum
    {
...
class DLL_EXPORT NeighborAdvertisementHeader: public ICMPv6Header
{
    enum
    {
...
class DLL_EXPORT NDPOptionField
{
...
class DLL_EXPORT RDNSSOption: public NDPOptionField
{
...
class DLL_EXPORT ARPIPv4ReplyFields
{
...
class DLL_EXPORT ARPIPv4RequestFields
{
...
class DLL_EXPORT DHCPOptionField
{
...
class DLL_EXPORT DHCPv6OptionField
{
